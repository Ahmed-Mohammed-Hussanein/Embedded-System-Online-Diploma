...
#define COL_PORT		KEYPAD_PORT_C		// This specifies port for columns for keypad.
											//  This parameter must be a value of @ref KEYPAD_PORT_define.

#define COL_0			KEYPAD_PIN_4		// This specifies pin for left column for keypad.
											//  This parameter must be a value of @ref KEYPAD_PIN_define.
				
#define COL_1			KEYPAD_PIN_5		// This specifies pin for the second left column for keypad.
											//  This parameter must be a value of @ref KEYPAD_PIN_define.
											
#define COL_2			KEYPAD_PIN_6		// This specifies pin for the third left column for keypad.
											//  This parameter must be a value of @ref KEYPAD_PIN_define.
											
#define COL_3			KEYPAD_PIN_7		// This specifies pin for the fourth left column for keypad.
											//  This parameter must be a value of @ref KEYPAD_PIN_define.
											
#define ROW_PORT		KEYPAD_PORT_C		// This specifies port for rows for keypad.
											//  This parameter must be a value of @ref KEYPAD_PORT_define.
...
#define ROW_2			KEYPAD_PIN_2		// This specifies pin for the third upper row for keypad.
											//  This parameter must be a value of @ref KEYPAD_PIN_define.

#define ROW_3			KEYPAD_PIN_3		// This specifies pin for the fourth upper row for keypad.
											//  This parameter must be a value of @ref KEYPAD_PIN_define.
