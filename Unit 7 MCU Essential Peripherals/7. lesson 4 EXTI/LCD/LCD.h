...
typedef struct  
{
	...
	uint16_t			LCD_RS_pin;						// This specifies the control pin RS for LCD.
													//  This parameter must be a value of @ref LCD_CTRL_PIN_define.
													
	uint16_t			LCD_EN_pin;						// This specifies the control pin EN for LCD.
													//  This parameter must be a value of @ref LCD_CTRL_PIN_define.
	
	uint16_t			LCD_RW_pin;						// This specifies the control pin RW for LCD.
													//  This parameter must be a value of @ref LCD_CTRL_PIN_define.
	
} LCD_controlConfig_t;


#define LCD_dataPort			GPIOA			// This specifies the port contains the control pins of lcd.
...
#define LCD_CTRL_PIN_8									GPIO_PIN_8
#define LCD_CTRL_PIN_9									GPIO_PIN_9
#define LCD_CTRL_PIN_10									GPIO_PIN_10
#define LCD_CTRL_PIN_11									GPIO_PIN_11
#define LCD_CTRL_PIN_12									GPIO_PIN_12
#define LCD_CTRL_PIN_13									GPIO_PIN_13
#define LCD_CTRL_PIN_14									GPIO_PIN_14
#define LCD_CTRL_PIN_15									GPIO_PIN_15
...
#define LCD_DATA_DB_PIN_8                              GPIO_PIN_8
#define LCD_DATA_DB_PIN_9                              GPIO_PIN_9
#define LCD_DATA_DB_PIN_10                             GPIO_PIN_10
#define LCD_DATA_DB_PIN_11                             GPIO_PIN_11
#define LCD_DATA_DB_PIN_12                             GPIO_PIN_12
#define LCD_DATA_DB_PIN_13                             GPIO_PIN_13
#define LCD_DATA_DB_PIN_14                             GPIO_PIN_14
#define LCD_DATA_DB_PIN_15                             GPIO_PIN_15
